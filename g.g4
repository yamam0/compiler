...
semicolon_stmt :
 ...
 /// cpp Section Instruction
func_cpp_stmt  : dtype ident  paramsection cpp_body;
...
assignment_stmt_cpp : assignment_cpp T_SEMICOLON
                    ;
assignment_cpp :  dtype ident T_EQUAL (int_number | dec_number)+
                | assignment_cpp T_COMMA  ident T_EQUAL (int_number | dec_number)+
                   ;
if_cpp_stmt :
         T_IF T_OPEN_P bool_expr T_CLOSE_P  cpp_body elseif_cpp_block* else_cpp_block?
       | T_IF T_OPEN_P bool_expr T_CLOSE_P  cpp_body elseif_cpp_block* else_cpp_block?

     ;
for_cpp_stmt : T_FOR T_OPEN_P  dtype ident T_EQUAL int_number T_SEMICOLON bool_expr T_SEMICOLON inc_cpp T_CLOSE_P T_OPEN_B cpp_loop_body* T_CLOSE_B;
...
cpp_loop_body:
              ...
              ;
if_loop_cpp_stmt :
        T_IF T_OPEN_P bool_expr T_CLOSE_P T_OPEN_B cpp_loop_body* T_CLOSE_B elseif_loop_cpp_block* else_loop_cpp_block?
       | T_IF T_OPEN_P bool_expr T_CLOSE_P  cpp_loop_body  elseif_loop_cpp_block* else_loop_cpp_block?
     ;
inc_cpp:  ident T_ADD T_ADD
        | ident T_SUBSUB
        | ident T_ADD T_EQUAL int_number
        | ident T_SUB T_EQUAL int_number
        | ident T_MUL T_EQUAL int_number
        ;

elseif_cpp_block :
       T_ELSEIF T_OPEN_P bool_expr T_CLOSE_P T_OPEN_B cpp_stmt T_CLOSE_B
     ;
else_cpp_block :
       T_ELSE T_OPEN_B cpp_stmt T_CLOSE_B
     ;
elseif_loop_cpp_block :
         T_ELSEIF T_OPEN_P bool_expr T_CLOSE_P T_OPEN_B cpp_loop_body* T_CLOSE_B
       | T_ELSEIF T_OPEN_P bool_expr T_CLOSE_P  cpp_loop_body
     ;
else_loop_cpp_block :
       T_ELSE T_OPEN_B  cpp_loop_body* T_CLOSE_B
       | T_ELSE  cpp_loop_body
     ;
...
from_clause :
       ...
       | syntax_error from_table_clause (from_join_clause)*
     ;
syntax_error : ;
